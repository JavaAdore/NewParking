...
//        }
    ...
    public static void main(String[] args) {
        ...
        HashMap<GarageStatus, List<ReportsInterface>> detailed = detailed(252);
        System.out.println();
...
//        }
    ...
    public static ReportHistoryRecord prepareSlotsHistoryRecord(ArrayList<ReportsInterface> list, String from, String to, int numberOfSlots) {
        ReportHistoryRecord result = new ReportHistoryRecord();
