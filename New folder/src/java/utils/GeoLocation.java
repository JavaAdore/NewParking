   ...
   private GeoLocation(){}
    ...
    public GeoLocation[] boundingCoordinates(double distance, double radius) {
        ...
        return new GeoLocation[]{
            new GeoLocation(minLat, minLon),
            new GeoLocation(maxLat, maxLon),
            new GeoLocation(minLat, maxLon),
            new GeoLocation(maxLat, minLon)
        };
    }

    public GeoLocation[] boundingCoordinates() {
        return boundingCoordinates(Constants.distance, 6378.1);
    }
}