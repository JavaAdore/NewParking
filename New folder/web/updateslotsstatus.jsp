    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            <c:forEach items="${garageSlots}" var="slot">
                        ...
                        var inner = "<div style=' left:${slot.getX()}px;top:" + y + "px ;position:absolute;width:20px;height:20px;background-color:yellow;'  ><input type='checkbox' "+status+" id='${slot.getSlotId()}' onchange='updateStatus(this)' ></input></div>";
