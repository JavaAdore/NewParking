...
public class GetContactList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            System.out.println(garageId + " "+ deleteButtonFormatingClass+" "+deleteButtonMethod);
            try {
                out.print(utils.Utils.loadContacts(Integer.parseInt(garageId), deleteButtonFormatingClass, deleteButtonMethod));
