        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (emp != null) {
                if (emp.getGarage() != null) {
                    ...
                    request.getSession().setAttribute("fromDate", extractMinMaxDate[0]);
                    request.getSession().setAttribute("toDate", extractMinMaxDate[1]);

                    // just send feedback to make sure that every thing is ok
                    out.print("ok");
                }
