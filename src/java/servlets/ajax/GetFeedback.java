...
public class GetFeedback extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (emp != null && deleteButtonFormatingClass != null && deleteButtonMethod != null) {
                ...
                } else if (emp.getRoles().getRoleName().equalsIgnoreCase(EmployeeRole.SERVICE_PROVIDER)) {
                    out.print(utils.Utils.loadFeedback(deleteButtonFormatingClass, deleteButtonMethod));
