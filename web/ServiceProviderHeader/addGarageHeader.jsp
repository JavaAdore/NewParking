<%-- 
    Document   : addGarageHeader
    Created on : Apr 6, 2014, 10:16:20 PM
    Author     : orcl
--%>
        ...
        <header id="header">
            <div class="5grid-layout">
                <div class="row">
                    ...
                    <h1>
                        <a href="#" class="mobileUI-site-name">Parking System</a></h1>
                    ...
                    <div class="12u" id="menu">
                        <nav class="mobileUI-site-nav">
                            <ul>
                                ...
                                <li class="current_page_item"><a href="addgarage.jsp">Add Garage</a></li>
