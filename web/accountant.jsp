                        ...
                        <div id="page-content-wrapper">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <input  id='fromPeriod' readonly type='text' onchange="isAReportDate('#fromPeriod', '#fromDateError')" />
                                    </td>    
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id='toPeriod' type='text' readonly onchange="isAReportDate('#toPeriod', '#toDateError')" />
                                    </td>  
